...
namespace SG2.CORE.WEB.Areas.SuperAdmin.Controllers
{
    ...
    public class CRMController : BaseController
    {
        ...
        // GET: SuperAdmin/CRM
        public ActionResult Index(int page = 1, string SearchCriteria = "", int? StatusId = null, string ProductId = null, string JVStatus = null, int? Subscription=null, int ? profileType = null, int? BlockStatus = null)
        {
            try
            {
                var customers = _customerManager.GetUserData(SearchCriteria, _PageSize, page, StatusId, ProductId, JVStatus, Subscription, profileType, BlockStatus);
